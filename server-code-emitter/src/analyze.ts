...
export function analyzeVersionImpact(program: Program, targetVersion: string): VersionImpactReport | undefined {
  ...
  if (!versioningMutators || versioningMutators.kind !== "versioned") return undefined;
...
export function formatReport(report: VersionImpactReport): string {
  const sep = "=".repeat(70);
  const lines: string[] = [];
